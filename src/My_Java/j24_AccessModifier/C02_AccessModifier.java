package My_Java.j24_AccessModifier;

public class C02_AccessModifier {

    public static <C01_AccessModifier> void main(String[] args) {
        ...
        C02_AccessModifier semra = new C01_AccessModifier();//default p'siz cons.

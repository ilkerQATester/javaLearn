package My_Java.J29_Exceptions;
...
public class C02_FileInputStreamException01 {
   ...
   Class'inin parent class Hz.Adem
    ...
    public static void main(String[] args) throws IOException {//Hz.Nuh IO işlemleri en parent class exception
        ...
        hata uyarısı altı kırmızı çizgi verir komutun derlenmesine izin vermez ve kod üzerine gelidiğimde
        Add...  exception handle etme tavsiye eder otamatih throws excp eklenir.

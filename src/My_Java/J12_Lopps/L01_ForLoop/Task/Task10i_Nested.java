package My_Java.J12_Lopps.L01_ForLoop.Task;

import java.util.Scanner;

public class Task10i_Nested {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("girdiğiniz cumle :"+cumle+"de istediğiniz harf :"+harf+ "   " + harfSayisi +" adettir.");

...
public class C02_PassByValue {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("indir11(fiyat) = " + indir11(fiyat));  // burada methoddan gelen veriyi atama yapmadığımız için ->
        System.out.println("indir22(fiyat) = " + indir22(fiyat));  // - instance value değişmedi C05_PassByValue örneğinde atama yapılmış hali var

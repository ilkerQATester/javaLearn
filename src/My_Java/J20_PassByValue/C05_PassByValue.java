package My_Java.J20_PassByValue;

public class C05_PassByValue {

    // datayı kalıcı hale getirmek için ya instance valuenuz static olmalı yada buradaki örnek gibi atama yapmamız lazım
    // ancak Class array list kullanılırsa C03_PassByValue örn.deki gibi atama yapılmadan yada static olmadan değer kalıcı olur.

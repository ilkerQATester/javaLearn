...
import IT2_OOP_Projects.ogrcOgrtYonetimiFinal.OgrenciVeOgretmen.Ogrenci;
import IT2_OOP_Projects.ogrcOgrtYonetimiFinal.OgrenciVeOgretmen.Ogretmen;
...
public class MethodClass extends Kisi {
    ...
    static String kisi;
    public  void ekleme() {//try catch lerle hatalar ayıklandı
            ...
            if (kimlikNo.length() != 11) {//2
                ...
                if (kisi.equalsIgnoreCase("Ogrenci")) {//3
                    ...
                    try {//4
                        ...
                        scan.nextLine();//dummy
                        if (yas < 8 || yas > 19) {//5
                            throw new ArithmeticException("Yas 8 ile 19 aralığında olmalıdır");
                        } else {//5
                            ...
                            Ogrenci obj = new Ogrenci(adSoyad, kimlikNo, yas, ogrenciNo, sinif); // parametreli cons.
                            ogrenci.add(obj);
                            System.out.println("eklenen ogrenci : "+ obj.getAdSoyad()); // encapsulation getter
                        }
                    } catch (Exception e) {
                        System.out.println(e.getMessage()); // encapsulation getter
                    }
                } else {//3
                    ...
                    try {//4
                        ...
                        if (yas < 23 ) {
                            ...
                            System.out.println("Kimya , Fizik , Biyoloji , Matematik , Geometri " +
                                    "branslarından birini giriniz :");
                            boolean flag = true;
                            // String brans = "";
                            try {//6
                                ...
                                if (flag) {//true olmasi durumu basvuran ogretmen istenen brans da degilse
                                    throw new ArrayStoreException("Geçerli branş isimlerinden bir giriş yapınız");
                                }else{
                                    System.out.println("sicil no gir (ornek : \"a12345\"  seklinde olmali ");
                                    // String sicilNo = "";
                                    try {
    ...
    public  void arama() {
        System.out.println("****** " + kisi + " arama sayfasina hosgeldiniz" + "*******");
        ...
        if (kisi.equalsIgnoreCase("ogrenci")) {
            ...
            if (flag) {//true buddy si
                System.out.println("aradiginiz " + kisi + " listede yoktur");
            }
        } else {
    ...
    public  void silme() {
        System.out.println("******  Dikkat ! " + kisi + " silme  sayfasındasınız" + "*******");

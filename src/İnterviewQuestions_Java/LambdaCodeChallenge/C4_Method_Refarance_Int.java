...
public class C4_Method_Refarance_Int {
    public static void main(String[] args) {
        ...
        System.out.println(negatifKareToplam(intL));
        pozitifKupMaxsimum(intL);
    }
    ...
    private static void pozitifKupMaxsimum(List<Integer> intL) {
        //intL.stream().filter(Methods::pozitifMi).map(Methods::kupBul).
    }

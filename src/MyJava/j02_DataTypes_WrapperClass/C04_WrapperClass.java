...
public class C04_WrapperClass {
    ...
    public static void main(String[] args) {
       ...
       String name="İlker";
       int yas=37;
       System.out.println(name.toUpperCase());//İLKER
        ...
        String okulNo="2345436"; // 6 yerine A harfi yazılırsa kod stringten integere çevrilemediği için diğer kodlar çalışmaz
